...
void arm_v6m_inst_stm(uint8_t* bin, uint64_t* bn, uint8_t rd, uint64_t* rl, uint8_t rn) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 192;
...
void arm_v6m_inst_ldm(uint8_t* bin, uint64_t* bn, uint8_t rd, uint64_t* rl, uint8_t rn) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 200;
