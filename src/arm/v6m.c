...
void arm_v6m_inst_push(uint8_t* bin, uint64_t* bn, uint8_t rd, uint8_t rs) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 180;
...
void arm_v6m_inst_pop(uint8_t* bin, uint64_t* bn, uint8_t rd, uint8_t rs) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 188;
...
void arm_v6m_inst_stm(uint8_t* bin, uint64_t* bn, uint8_t rd, uint8_t k) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 192;
...
void arm_v6m_inst_ldm(uint8_t* bin, uint64_t* bn, uint8_t rd, uint8_t k) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 200;
...
void arm_v6m_inst_msr(uint8_t* bin, uint64_t* bn, uint8_t rd, uint8_t rs) { //todo
	bin[*bn] = 128;
	bin[*bn + 1] = 243;
	bin[*bn + 2] = 0;
	bin[*bn + 3] = 128;
...
void arm_v6m_inst_mrs(uint8_t* bin, uint64_t* bn, uint8_t rd, uint8_t rs) { //todo
	bin[*bn] = 224;
	bin[*bn + 1] = 243;
	bin[*bn + 2] = 0;
	bin[*bn + 3] = 128;
...
void arm_v6m_inst_bl(uint8_t* bin, uint64_t* bn, uint32_t k) { //todo
	bin[*bn] = 0;
	bin[*bn + 1] = 240;
	bin[*bn + 2] = 0;
	bin[*bn + 3] = 248;
...
void arm_v6m_enc(uint8_t* bin, uint64_t* bn, int8_t* op, uint8_t* rt, uint64_t* rv, int8_t* e, int8_t* path, uint64_t ln) {
	...
	if (op[0] == 'l' && op[1] == 's' && op[2] == 'l' && op[3] == 0) {
		...
		if (rt[0] == 1 && rt[1] == 1 && (rt[2] == 2 || rt[2] == 3)) {
			arm_v6m_err_r3(rv[0], e, path, ln);
		...
		if (rt[0] == 1 && rt[1] == 1 && rt[2] == 0) { //todo
			arm_v6m_inst_push(bin, bn, rv[0], rv[1]);
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "push");
			*e = -1;
		...
		if (rt[0] == 1 && rt[1] == 1 && rt[2] == 0) { //todo
			arm_v6m_inst_pop(bin, bn, rv[0], rv[1]);
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "pop");
			*e = -1;
		...
		if (rt[0] == 1 && (rt[1] == 2 || rt[1] == 3) && rt[2] == 0) { //todo
			arm_v6m_err_r3(rv[0], e, path, ln);
			arm_v6m_inst_stm(bin, bn, rv[0], rv[1]);
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "stm");
			*e = -1;
		...
		if (rt[0] == 1 && (rt[1] == 2 || rt[1] == 3) && rt[2] == 0) { //todo
			arm_v6m_err_r3(rv[0], e, path, ln);
			arm_v6m_inst_ldm(bin, bn, rv[0], rv[1]);
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "ldm");
			*e = -1;
	...
	else if (op[0] == 'l' && op[1] == 't' && op[2] == 'd' && op[3] == 'f' && op[4] == 'd' && op[5] == 0) {
		if (rt[0] == 1 && (rt[1] == 2 || rt[1] == 3) && rt[2] == 0) { //todo
			arm_v6m_err_r3(rv[0], e, path, ln);
			arm_v6m_inst_ldm(bin, bn, rv[0], rv[1]);
		}
	...
	else if (op[0] == 'u' && op[1] == 'd' && op[2] == 'f' && op[3] == 0) { //todo
		if ((rt[0] == 2 || rt[0] == 3) && rt[1] == 0 && rt[2] == 0) {
			arm_v6m_err_k8(rv[0], e, path, ln);
	...
	else if (op[0] == 's' && op[1] == 'v' && op[2] == 'c' && op[3] == 0) { //todo
		if ((rt[0] == 2 || rt[0] == 3) && rt[1] == 0 && rt[2] == 0) {
			arm_v6m_err_k8(rv[0], e, path, ln);
	...
	else if (op[0] == 'm' && op[1] == 's' && op[2] == 'r' && op[3] == 0) { //todo
		if (rt[0] == 1 && rt[1] == 1 && rt[2] == 0) {
			arm_v6m_err_r4(rv[0], e, path, ln);
	...
	else if (op[0] == 'm' && op[1] == 'r' && op[2] == 's' && op[3] == 0) { //todo
		if (rt[0] == 1 && rt[1] == 1 && rt[2] == 0) {
			arm_v6m_err_r4(rv[0], e, path, ln);
			arm_v6m_err_rs(rv[1], e, path, ln);
