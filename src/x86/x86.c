...
void x86_enc(uint8_t* bin, uint64_t* bn, int8_t* op, uint8_t* rt, uint64_t* rv, int8_t* e, int8_t* path, uint64_t ln) {
	if (op[0] == 'a' && op[1] == 'd' && op[2] == 'd' && op[3] == 0) {
		...
		if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && rv[1] == 1) { //mod 0
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && rv[1] < 256 && rv[1] > -128 && rv[2] == 1) { //mod 1
			uint8_t a = x86_err_a16(rv[0], 8, e, path, ln);
			...
			x86_inst_byt(bin, bn, 208 + !!(rv[0] & 48)); //op
			x86_inst_mod(bin, bn, 3, rv[0], 0); //modrm
		}
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 1 && rt[3] == 0 && rv[1] < 256 && rv[1] > -128 && rv[2] == 1) { //mod 1
			uint8_t a = x86_err_a16(rv[0], 8, e, path, ln);
			...
			x86_inst_byt(bin, bn, 210 + !!(rv[0] & 48)); //op
			x86_inst_mod(bin, bn, 3, rv[0], 0); //modrm
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "rol");
		...
		if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[0] & 15) == 0) { //mod 0
			x86_err_reg(rv[0], rv[1], e, path, ln);
			uint8_t a = x86_err_a16(rv[1], 8, e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 6 && rt[3] == 0 && (rv[0] & 15) == 0 && rv[2] < 256 && rv[2] > -128) { //mod 1
			x86_err_reg(rv[0], rv[1], e, path, ln);
			uint8_t a = x86_err_a16(rv[1], 8, e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 6 && rt[3] == 0 && (rv[0] & 15) == 0) { //mod 2
			x86_err_reg(rv[0], rv[1], e, path, ln);
			uint8_t a = x86_err_a16(rv[1], 8, e, path, ln);
			x86_err_k16(rv[1], e, path, ln);
			...
			x86_inst_byt(bin, bn, 246 + !!(rv[1] & 48)); //op
