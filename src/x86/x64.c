...
void x86_64_err_k8(uint64_t k, int8_t* e, int8_t* path, uint64_t ln) {
	if (k > 255) {
...
void x86_64_err_k16(uint64_t k, int8_t* e, int8_t* path, uint64_t ln) {
	if (k > 65535) {
		printf("[%s, %lu] error: immediate '%u' out of range\n", path, ln, k);
		*e = -1;
	}
...
void x86_64_err_k32(uint64_t k, int8_t* e, int8_t* path, uint64_t ln) {
	if (k > 4294967295) {
		printf("[%s, %lu] error: immediate '%u' out of range\n", path, ln, k);
		*e = -1;
	}
...
void x86_64_err_lcp(uint8_t r, uint64_t k, int8_t* e, int8_t* path, uint64_t ln) {
	if ((r & 48) == 0 && k > 255) {
		printf("[%s, %lu] error: immediate '%u' out of range\n", path, ln, k);
		*e = -1;
	}
...
uint8_t x86_64_err_s8(uint64_t k, int8_t* e, int8_t* path, uint64_t ln) {
	if (k == 1) {
		return 0;
	}
	else if (k == 2) {
...
void x86_64_enc(uint8_t* bin, uint64_t* bn, int8_t* op, uint8_t* rt, uint64_t* rv, int8_t* e, int8_t* path, uint64_t ln) {
	if (op[0] == 'a' && op[1] == 'd' && op[2] == 'd' && op[3] == 0) {
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 1 && rt[3] == 0 && (rv[0] & 7) == 5) {
			x86_64_err_364(rv[0], e, path, ln);
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_rsp(rv[1], e, path, ln);
			uint8_t s = x86_64_err_s8(rv[2], e, path, ln);
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 0 + !!(rv[4] & 48)); //op
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[1] & 7) == 5) { //mod 0
			x86_64_err_364(rv[1], e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 6 && rt[3] == 0 && (rv[1] & 7) == 5) {
			x86_64_err_364(rv[1], e, path, ln);
			x86_64_err_k32(rv[2], e, path, ln);
			...
			*((uint8_t*) rv[2]) |= 4; //rel
			...
			x86_64_err_reg(rv[1], rv[2], e, path, ln);
			x86_64_err_rsp(rv[2], e, path, ln);
			uint8_t s = x86_64_err_s8(rv[3], e, path, ln);
			
			x86_64_prfx_leg(bin, bn, rv[1], rv[0]);
			x86_64_prfx_rex(bin, bn, rv[1], rv[2], rv[0]);
			x86_64_inst_byt(bin, bn, 2 + !!(rv[0] & 48)); //op
			x86_64_inst_mod(bin, bn, s, 4, rv[0]); //modrm
			x86_64_inst_mod(bin, bn, 0, rv[1], rv[2]); //sib
		}
			...
			x86_64_inst_byt(bin, bn, rv[4]); //disp
		}
			...
			x86_64_inst_mod(bin, bn, 2, 4, rv[0]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[1], rv[2]); //sib
			x86_64_inst_k32(bin, bn, rv[4]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 15) == 0) { //axk
			x86_64_err_lcp(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_leg(bin, bn, 0, rv[0]);
			x86_64_prfx_rex(bin, bn, rv[0], 0, rv[0] & 48);
			x86_64_inst_byt(bin, bn, 128 + !!(rv[0] & 48)); //op
			x86_64_inst_mod(bin, bn, 3, rv[0], 0); //modrm
			x86_64_inst_lcp(bin, bn, rv[0], rv[1]); //imm
		}
		else {
		...
		if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 5) {
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 4) {
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k8(rv[1], e, path, ln);
			...
			*((uint8_t*) rv[1]) |= 4; //rel
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[1] < 256) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k8(rv[2], e, path, ln);
			...
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
			x86_64_inst_byt(bin, bn, rv[4]); //imm
		}
		...
		if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 5 && rv[1] < 256) { //mod 0
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 5 && rv[2] < 256) {
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 4 && rv[1] < 256) {
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] == 101 || rv[0] == 117) && rv[1] < 256) {
			x86_64_inst_byt(bin, bn, 102); //leg op
			x86_64_prfx_leg(bin, bn, rv[0], 0);
			x86_64_inst_byt(bin, bn, 131); //op
			x86_64_inst_mod(bin, bn, 0, 5, 0); //modrm
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] == 101 || rv[0] == 117) && rv[2] < 256) {
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 7 && rt[2] == 2 && rt[3] == 0 && (rv[0] == 101 || rv[0] == 117) && rv[2] < 256) {
			*((uint8_t*) rv[1]) |= 4; //rel
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[1] < 256 && rv[2] < 256) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[2] < 256) { //mod 2
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			x86_64_err_364(rv[0], e, path, ln);
			...
			x86_64_inst_mod(bin, bn, 0, 5, 4); //sib
			x86_64_inst_k32(bin, bn, rv[1]); //disp
			x86_64_inst_k16(bin, bn, rv[2]); //imm
		}
		else if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 4) {
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k16(rv[1], e, path, ln);
			...
			*((uint8_t*) rv[0]) |= 4; //rel
			...
			x86_64_inst_mod(bin, bn, 0, 4, 0); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_k16(bin, bn, rv[3]); //imm
		}
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[1] < 256) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k16(rv[2], e, path, ln);
			...
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
			x86_64_inst_k16(bin, bn, rv[4]); //imm
		}
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4) { //mod 2
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 5 && rv[1] < 256) { //mod 0
			...
			*((uint8_t*) rv[0]) |= 4; //rel
			...
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
			x86_64_inst_k32(bin, bn, rv[4]); //imm
		}
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4) { //mod 2
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_inst_mod(bin, bn, s, 4, rv[3]); //modrm
			x86_64_inst_mod(bin, bn, 0, rv[0], rv[1]); //sib
		}
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 1 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[1] < 256) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 8 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 16 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 24 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 10 && rt[3] == 0) {
			x86_64_err_364(rv[1], e, path, ln);
			x86_64_err_364(rv[2], e, path, ln);
			x86_64_err_reg(rv[1], rv[2], e, path, ln);
			x86_64_err_rsp(rv[2], e, path, ln);
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //modrm
			x86_64_err_364(rv[0], e, path, ln);
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 32 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 40 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 48 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 56 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 0 && (rv[0] & 7) == 4 && rv[1] < 256) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 0 && (rv[0] & 7) == 5) { //mod 0
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 0 && (rv[0] & 7) == 4) {
			x86_64_err_364(rv[0], e, path, ln);
		...
		if (rt[0] == 5 && rt[1] == 6 && rt[2] == 1 && rt[3] == 0 && (rv[0] & 7) == 5) { //mod 0
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_leg(bin, bn, rv[0], rv[4]);
			x86_64_prfx_rex(bin, bn, rv[0], rv[1], rv[4]);
			x86_64_inst_byt(bin, bn, 136 + !!(rv[4] & 48)); //op
			x86_64_inst_mod(bin, bn, 1, 4, rv[4]); //modrm
			x86_64_inst_mod(bin, bn, s, rv[0], rv[1]); //sib
			x86_64_inst_byt(bin, bn, rv[3]); //disp
		}
		...
		else if (rt[0] == 5 && rt[1] == 2 && rt[2] == 0 && (rv[0] & 7) == 4 && rv[1] < 256) { //mod 0
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 10 && rt[3] == 6 && rt[4] == 0) {
			x86_64_err_264(rv[0], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			x86_64_err_364(rv[2], e, path, ln);
			x86_64_err_reg(rv[1], rv[2], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 2 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[1] < 256 && rv[2] == 1) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 6 && rt[2] == 1 && rt[3] == 0 && (rv[0] & 7) == 4 && rv[1] < 256 && rv[2] == 1) { //mod 1
			x86_64_err_364(rv[0], e, path, ln);
		...
		else if (rt[0] == 5 && rt[1] == 9 && rt[2] == 3 && rt[3] == 6 && rt[4] == 1 && rt[5] == 0 && rv[4] == 1) {
			x86_64_err_364(rv[0], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_rsp(rv[1], e, path, ln);
	...
	else if (op[0] == 'j' && op[1] == 'r' && op[2] == 'c' && op[3] == 'x' && op[4] == 'z' && op[5] == 0) {
		if (rt[0] == 2 && rt[1] == 0 && rv[0] < 256 && rv[0] > -128) {
			x86_64_inst_byt(bin, bn, 227); //op
			x86_64_inst_byt(bin, bn, rv[0]); //imm
		}
		else if (rt[0] == 3 && rt[1] == 0) {
			*((uint8_t*) rv[0]) |= 1; //rel
		...
		if (rt[0] == 2 && rt[1] == 0 && rv[0] < 256 && rv[0] > -128) {
			x86_64_inst_byt(bin, bn, 103); //leg
			x86_64_inst_byt(bin, bn, 227); //op
			x86_64_inst_byt(bin, bn, rv[0]); //imm
		}
		else if (rt[0] == 3 && rt[1] == 0) {
		...
		if (rt[0] == 1 && rt[1] == 2 && rt[2] == 0 && rv[0] == 0) {
			...
			x86_64_inst_byt(bin, bn, 236); //op
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && rv[0] == 16 && rv[1] == 18) {
			x86_64_inst_byt(bin, bn, 102); //leg op
			x86_64_inst_byt(bin, bn, 237); //op
		}
		...
		if (rt[0] == 2 && rt[1] == 1 && rt[2] == 0 && rv[1] == 0) {
			...
			x86_64_inst_byt(bin, bn, 238); //op
		}
		else if (rt[0] == 5 && rt[1] == 1 && rt[2] == 0 && rv[0] == 18 && rv[1] == 16) {
			x86_64_inst_byt(bin, bn, 102); //leg op
			x86_64_inst_byt(bin, bn, 239); //op
		}
		...
		if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[0] & 15) == 0 && (rv[1] & 7) == 4) { //mod 0
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[0], e, path, ln);
			
			x86_64_prfx_leg(bin, bn, rv[1], 0);
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 0, 4, 4); //modrm
			x86_64_inst_mod(bin, bn, 0, 4, 4); //sib
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[0] & 15) == 0 && (rv[1] == 101 || rv[1] == 117)) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 6 && rt[3] == 0 && (rv[0] & 15) == 0 && (rv[1] == 101 || rv[1] == 117)) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 7 && rt[3] == 0 && (rv[0] & 15) == 0 && (rv[1] == 101 || rv[1] == 117)) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 0, rv[1], 4); //modrm
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			x86_64_err_364(rv[2], e, path, ln);
			x86_64_err_reg(rv[1], rv[1], e, path, ln);
			x86_64_err_rsp(rv[2], e, path, ln);
			
			x86_64_prfx_leg(bin, bn, rv[1], 0);
			x86_64_prfx_rex(bin, bn, rv[1], rv[2], 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 0, 4, 4); //modrm
			x86_64_inst_mod(bin, bn, 0, rv[1], rv[2]); //sib
		}
		...
		else if (rt[0] == 1 && rt[1] == 6 && rt[2] == 1 && rt[3] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_k32(rv[1], e, path, ln);
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 6 && rt[3] == 0 && (rv[0] & 15) == 0 && (rv[1] & 7) == 4 && rv[2] < 256) { //mod 1
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 1, rv[1], 4); //modrm
			x86_64_inst_byt(bin, bn, rv[2]); //disp
		}
		...
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 6 && rt[3] == 0 && (rv[0] & 15) == 0 && (rv[1] & 7) == 4) { //mod 2
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			x86_64_err_k32(rv[2], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 2, rv[1], 4); //modrm
			x86_64_inst_k32(bin, bn, rv[2]); //disp
		}
			...
			x86_64_prfx_leg(bin, bn, 0, rv[1]);
			x86_64_prfx_rex(bin, bn, rv[1], 0, rv[1] & 48);
			x86_64_inst_byt(bin, bn, 246 + !!(rv[1] & 48)); //op
			x86_64_inst_mod(bin, bn, 3, rv[1], 4); //modrm
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "mul");
			*e = -1;
		...
		if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[0] & 15) == 0 && (rv[1] & 7) == 4) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 0, rv[1], 5); //modrm
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 1, rv[1], 5); //modrm
			x86_64_inst_byt(bin, bn, rv[2]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 6 && rt[4] == 0 && (rv[0] & 15) == 0 && rv[3] < 256) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 2, rv[1], 5); //modrm
			x86_64_inst_k32(bin, bn, rv[2]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 6 && rt[4] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, rv[1] & 48);
			x86_64_inst_byt(bin, bn, 246 + !!(rv[1] & 48)); //op
			x86_64_inst_mod(bin, bn, 3, rv[1], 5); //modrm
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "imul");
			*e = -1;
		...
		if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[0] & 15) == 0 && (rv[1] & 7) == 4) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 0, rv[1], 6); //modrm
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 1, rv[1], 6); //modrm
			x86_64_inst_byt(bin, bn, rv[2]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 6 && rt[4] == 0 && (rv[0] & 15) == 0 && rv[3] < 256) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 2, rv[1], 6); //modrm
			x86_64_inst_k32(bin, bn, rv[2]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 6 && rt[4] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, rv[1] & 48);
			x86_64_inst_byt(bin, bn, 246 + !!(rv[1] & 48)); //op
			x86_64_inst_mod(bin, bn, 3, rv[1], 6); //modrm
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "div");
			*e = -1;
		...
		if (rt[0] == 1 && rt[1] == 5 && rt[2] == 0 && (rv[0] & 15) == 0 && (rv[1] & 7) == 4) { //mod 0
			...
			*((uint8_t*) rv[1]) |= 4; //rel
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 0, rv[1], 7); //modrm
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			x86_64_err_364(rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 1, rv[1], 7); //modrm
			x86_64_inst_byt(bin, bn, rv[2]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 6 && rt[4] == 0 && (rv[0] & 15) == 0 && rv[3] < 256) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, 0);
			x86_64_inst_byt(bin, bn, 247); //op
			x86_64_inst_mod(bin, bn, 2, rv[1], 7); //modrm
			x86_64_inst_k32(bin, bn, rv[2]); //disp
		}
		else if (rt[0] == 1 && rt[1] == 5 && rt[2] == 9 && rt[3] == 6 && rt[4] == 0 && (rv[0] & 15) == 0) {
			x86_64_err_reg(rv[0], rv[1], e, path, ln);
			...
			x86_64_prfx_rex(bin, bn, rv[1], 0, rv[1] & 48);
			x86_64_inst_byt(bin, bn, 246 + !!(rv[1] & 48)); //op
			x86_64_inst_mod(bin, bn, 3, rv[1], 7); //modrm
		}
		else {
			printf("[%s, %lu] error: illegal usage of opcode '%s'\n", path, ln, "idiv");
			*e = -1;
