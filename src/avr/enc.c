...
int8_t* avr_err(int8_t e) {
	if (e == 1) {
		...
		return "operand must be registers r0 - r31, given";
	}
	else if (e == 5) {
		return "operand must be registers r16 - r31, given";
	}
	else if (e == 6) {
		return "operand must be registers r16 - r23, given";
	}
	else if (e == 7) {
		return "operand must be pointers w, x, y, or z, given";
	}
	else if (e == 8) {
		return "operand must be pointers x, y, or z, given";
	}
}
